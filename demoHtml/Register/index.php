							...
							<div class="advertis-event" id="direction">
								<div id="articles" style="line-height:180%;">
									<div class="case-article-content">
									   	<?php require_once DEFAULT_VIEW_PATH.'/Register/form.php';?>
									 	<style>
										 	.am-form{padding:0px!important;}
											.am-form legend{color:#888}
											.am-form-group,legend{margin-left:20px;}
											.am-btn-block{margin-left:120px;}
										</style>
									</div>
								</div>
							</div>
